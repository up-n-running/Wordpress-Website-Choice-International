...
function ueme_install() {
	...
	$sql = "CREATE TABLE " . UEME_ZOOM_SETTINGS_TABLE . " (
                ...
                zoomset_link_active_mins INT(10) NOT NULL DEFAULT -1,
    ...
    if( $number_of_settings==0 ) {
        $wpdb->query("INSERT INTO " . UEME_ZOOM_SETTINGS_TABLE . " (zoomset_name, zoomset_detach_recurrences, zoomset_link_active_mins, zoomset_api_key) VALUES ('Zoom Event - Use individual Event Links', 1, 60, '')" );
        $wpdb->query("INSERT INTO " . UEME_ZOOM_SETTINGS_TABLE . " (zoomset_name, zoomset_detach_recurrences, zoomset_link_active_mins, zoomset_api_key) VALUES ('Zoom Event - Use Link from Recurring Event', 0, 60, '')" );
    }  
